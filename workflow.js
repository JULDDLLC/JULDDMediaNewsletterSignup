...
async function sendConfirmationEmail(email, parentName, childrenNames = "N/A") {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; line-height: 1.6;">
      ...
      <p>Look for your first newsletter in your inbox soon. If you don't see it, check your spam folder (Gmail users: add onboarding@resesend.dev to your contacts). If you have any questions, feel free to reply to this email or contact us at <a href="mailto:support@julddmedia.com">support@julddmedia.com</a>.</p>
